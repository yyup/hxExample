...
<html>
	...
	<body class="body1">
		<div class="formInfo">
			...
			<a class="easyui-linkbutton" data-options="iconCls:'icon-remove',size:'small',plain:'true'" style="margin-left:10px;" onclick="javascript:delMessages();">删除</a>
		...
		<script type="text/javascript">
			...
			function fmtdetail(val,row) {
				return "<span><a href='javascript:messageDetail(\"" +row.hxuuid+ "\");' title='消息详情'>详情</a></span>";
			}
			//查看详情
