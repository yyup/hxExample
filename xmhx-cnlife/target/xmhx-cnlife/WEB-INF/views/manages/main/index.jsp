					...
					onSelect:function(title, index) {
						if ( title == '生产问题管理'){
							...
							for (var i = 0; i < ifrms.length; i++ ){
								if ( ifrms[i].src.indexOf('prdmanage.hx') != -1 ){
									k = i;
									break;
								}
							}
							...
							var k = -1;
							for (var i = 0; i < ifrms.length; i++ ){
								if ( ifrms[i].src.indexOf('rmmanage.hx') != -1 ){
									k = i;
									break;
								}
							}
							...
							var k = -1;
							for (var i = 0; i < ifrms.length; i++ ){
								if ( ifrms[i].src.indexOf('bugmanage.hx') != -1 ){
									k = i;
									break;
								}
							}
							...
							var k = -1;
							for (var i = 0; i < ifrms.length; i++ ){
								if ( ifrms[i].src.indexOf('srmanage.hx') != -1 ){
									k = i;
									break;
								}
							}
							...
							var k = -1;
							for (var i = 0; i < ifrms.length; i++ ){
								if ( ifrms[i].src.indexOf('rdmanage.hx') != -1 ){
									k = i;
									break;
								}
							}
