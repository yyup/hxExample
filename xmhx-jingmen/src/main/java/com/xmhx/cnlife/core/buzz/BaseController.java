...
//	}
	 ...
	 * 图片展示路径
	 */
	protected String getDisplayphotodir() {
		String displayphotodir = configMap.get("xmhx.displayphotodir");
		return displayphotodir;
	}
	...
	public UserDTO getLoginInfo(HttpServletRequest request) {
		return (UserDTO) request.getSession().getAttribute(SessionSettings.VIEWUSER_SESSION);
	}
}
