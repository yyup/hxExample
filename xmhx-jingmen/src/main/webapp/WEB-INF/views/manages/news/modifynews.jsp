...
<html>
	...
	<body>
		...
		<div class="box">
  			<form action="modifynews.hx" name="newsfrm" id="newsfrm" method="post">
				 <dl id="dl">
	      			<dt class="f14 b">修改新闻</dt>
	      			<dd>
	      				<span class="title">标题：</span>
	      				<input class="reg_input" name="newsTitle" id="newsTitle" value="${news.newsTitle }" style="width: 240px" />
	        		...
	        		<dd>
	      				...
	      				<textarea class="reg_input" name="newsSubtitle" id="newsSubtitle" 
								style="width:350px; height:100px;margin-left:0px;">${news.newsSubtitle }</textarea>
						<span style="color:red">*</span>
						<span id="newsSubtitleTip" class="onshow"></span>
	        		</dd>
	      			<dd>
	      				<span class="title">标题图：</span>
	      				<a id="uploadImage" class="easyui-linkbutton" href="javascript:doUpload();">修改图片</a>
	      				<span style="color:red">*</span>
	        		...
	        		<dd>
	        			...
	        			<textarea class="reg_input" name="newsContent" id="newsContent" 
								style="width: 350px; height: 290px;">${news.newsContent }</textarea>
	        		    <span id="msgTip" class="onshow"></span>
	        		    </div>
	        		</dd>
	        	</dl>
	          <div class="f_reg_but">
	                <input type="button" value="保存" class="l_button" onclick="onmodifynews();"/>
