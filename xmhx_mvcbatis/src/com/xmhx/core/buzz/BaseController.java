...
import com.xmhx.buzz.utils.PropertiesUtils;
import com.xmhx.buzz.utils.encrypt.SecurityUtil;
import com.xmhx.core.model.PushMsg;
...
public class BaseController {
	...
	public List<UserDTO> getUsers(HttpServletRequest request) {
		return (List<UserDTO>) request.getServletContext().getAttribute(SessionSettings.GENERAL_USERS);
	}
	...
	public List<MenuDTO> getMenus(HttpServletRequest request) {
		return (List<MenuDTO>) request.getServletContext().getAttribute(SessionSettings.ALL_MENU_URLS);
	}
